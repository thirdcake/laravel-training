...
<details>
<summary role="button" class="outline">名言の出力方法</summary>
...
- PHPUnit\Framework\Assert->assertTrue($condition)（$condition がtrueか）
- PHPUnit\Framework\Assert->assertContains($needle, $haystack)（$heystack に $needle が見つかるか）
